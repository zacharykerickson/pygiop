...
# -*- coding: utf-8 -*-
"""
Created on Mon May 10 09:40:48 2021
...
#@segasai
#segasai finally make a py3 working version of mpfit
#Latest commit dad326f on 3 Feb 2017
##History
#1 contributor
#2338 lines (2024 sloc) 76.5 KB
"""
   ...
   Outputs:
	...
	def fdjac2(self, fcn, x, fvec, step=None, ulimited=None, ulimit=None, dside=None,
		...
		if autoderivative == 0:
            ...
            #BUG IN THIS CHECKING ROUTINE#
            #NOTED BY L. MCKINNA#
            #Dimension checking seems off#
            #changed first part of if statement
            #from len(fjac) !+ m*nall to:
            #numpy.prod(fjac.shape) !- m*nall
            
			if numpy.prod(fjac.shape) != m*nall:
